...
?>
    ...
    <section>
        <fieldset>
            ...
            <ul>
                <li>
                    <a href="https://gitlab.com/Teacher01/learning-template.git" target="_blank">https://gitlab.com/Teacher01/learning-template.git</a>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <a href="https://packagist.org/?query=slugify" target="_blank">https://packagist.org/?query=slugify</a>
                </li>
            </ul>

            <p><code>composer require cocur/slugify</code></p>

            <h2>2019‑11‑14 : Consigne phase 02</h2>

            <ol>
                <li>Créez articles et ses détails.</li>>
                <li>Et créez la classe User la table, créer des Fakers.</li>
                <li>Et gérer la sécurité.</li>
            </ol>

            <h2>2019‑11‑15 : Consigne phase 03</h2>
            <h3>prof</h3>
            <ul>
                <li>createdAt</li>  <!-- DateTime -->
                <li>updatedAt</li>  <!-- DateTime -->
                <li>lastLogAt</li>  <!-- DateTime -->
                <li>isDisabled</li> <!-- Boolean -->
                <li>image</li>      <!-- Avatar -->
